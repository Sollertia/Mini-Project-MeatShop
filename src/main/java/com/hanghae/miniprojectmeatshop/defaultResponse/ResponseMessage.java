...
public class ResponseMessage {
    ...
    public static final String UPDATE_SKILL_SUCCESS = "주특기 업데이트 성공";
    public static final String UPDATE_SKILL_FAILED = "주특기 업데이트 실패";
    public static final String INTERNAL_SERVER_ERROR = "서버 내부 에러";
    public static final String DB_ERROR = "데이터베이스 에러";
    public static final String GET_ITEM_SUCCESS = "상품 조회 성공";
    public static final String UPDATE_ITEM_SUCCESS = "상품 수정 성공";
    public static final String DELETE_ITEM_SUCCESS = "상품 삭제 성공";
    ...
    public static final String USER_NOT_FOUND = "유저정보를 찾을 수 없습니다";
    public static final String CREATE_ITEM = "상품이 성공적으로 등록되었습니다.";
